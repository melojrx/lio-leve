"""Fix division by zero in portfolio_allocation view."""
from __future__ import annotations

from alembic import op

# revision identifiers, used by Alembic.
revision = "20251120_0003"
down_revision = "20251120_0002"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # Revert to previous definition (with division risk) if needed
    op.execute(
        """
        CREATE OR REPLACE VIEW portfolio_allocation AS
        WITH user_totals AS (
